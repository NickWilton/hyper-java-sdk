...
/**
 * Modified from code by @author Richard Lucas
 */
public class HyperSigner {

	private static final String AUTH_TAG = "HYPER";
	private static final String ALGORITHM = AUTH_TAG + "-HMAC-SHA256";
	private static final String TERMINATION_STRING = "hyper_request";
	private static final Charset UTF_8 = Throwables.returnableInstance(() -> Charset.forName("UTF-8"), SigningException::new);
	private static final String X_AMZ_DATE = "X-Hyper-Date";
	private static final String HMAC_SHA256 = "HmacSHA256";

	private final com.guidedsoftware.hyper.CanonicalRequest request;
	private final AwsCredentials awsCredentials;
	private final String service;
	private final String region;

	private HyperSigner(com.guidedsoftware.hyper.CanonicalRequest request, AwsCredentials awsCredentials, String service, String region) {
	...
	public static class Builder {
		...
		private static final String HYPER = "com/guidedsoftware/hyper";
		...
		public HyperSigner build(HttpRequest request, String service, String contentSha256) {
			return new HyperSigner(new com.guidedsoftware.hyper.CanonicalRequest(request, getCanonicalHeaders(), contentSha256), getAwsCredentials(), service, region);
		}

		public HyperSigner buildHyper(HttpRequest request, String contentSha256) {
			return build(request, HYPER, contentSha256);
		}
